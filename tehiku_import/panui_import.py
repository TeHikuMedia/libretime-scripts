...
url = 'https://tehiku.nz/api/te-reo/panui/latest?mp3=True'
url2 = 'https://tehiku.nz/api/te-reo/panui/latest'
...
title = u"Panui %s" % (dt.strftime('%d%m%y'))
...
commands.getstatusoutput('mv %s /srv/airtime/watch_folder/tehiku_panui/'%(f_name))
commands.getstatusoutput('sudo chown www-data /srv/airtime/watch_folder/tehiku_panui/%s'%(f_name))
commands.getstatusoutput('sudo chgrp www-data /srv/airtime/watch_folder/tehiku_panui/%s'%(f_name))
