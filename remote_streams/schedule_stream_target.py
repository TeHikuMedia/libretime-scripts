...
START_TIME = datetime.strptime('2020/04/2 13:00:00', '%Y/%m/%d %H:%M:%S').astimezone(timezone)
END_TIME = datetime.strptime('2020/04/2 17:00:00', '%Y/%m/%d %H:%M:%S').astimezone(timezone)
